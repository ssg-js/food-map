...
const BASE_RESTAURANTS: SeedRestaurant[] = [
  {
    id: "1",
    name: "맛있는 김치찌개",
...
const GENERATED_RESTAURANTS: SeedRestaurant[] = DISTRICTS.flatMap(
  (district, districtIndex) =>
    RESTAURANT_CONCEPTS.map((concept, conceptIndex): SeedRestaurant => {
